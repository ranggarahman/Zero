...
import com.example.zero.databinding.AnotherItemBadgesBinding
...
class AnotherBadgesAdapter(private val badgesList: List<Badges>) :
    RecyclerView.Adapter<AnotherBadgesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = AnotherItemBadgesBinding.inflate(
            LayoutInflater.from(parent.context),
            parent,
            false
        )
    ...
    inner class ViewHolder(private val binding: AnotherItemBadgesBinding) :
        RecyclerView.ViewHolder(binding.root) {
