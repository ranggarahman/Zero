...
class CongratsPopupDialogFragment: DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val title = arguments?.getString(BadgesFragment.BADGE_TITLE)
        val desc = arguments?.getString(BadgesFragment.BADGE_DESC)
        val imgUrl = arguments?.getString(BadgesFragment.BADGE_IMG_URL)
